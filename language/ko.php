<?php
    $lang_array = array (
        ...
        "address" => "서울시 성동구 아차산로 49 (성수동1가 14-18) 서울숲코오롱디지털타워3차 1602호",
        "policy" => "Privacy Policy",

        "email_contact" => "이메일 문의",
        "category" => "카테고리",
        "select_category" => "카테고리 선택",
        "partnership" => "제휴",
        "product_inquiry" => "제품관련문의",
        "product_service" => "제품서비스문의(AS)",
        "purchase_date" => "제품구매일",
        "others" => "기타",
        "name" => "성명",
        "email" => "이메일",
        ...
        "are_you_agree" => "개인정보 수집 및 이용에 동의합니다.",
        "send" => "보내기"
    );
?>